...
const start = async () => {
  ...
  const dropNumber = async (context) => {
    ...
    //console.clear();
      ...
      console.clear();
      console.log(gradient('red', 'blue')('💀Number Locking by @SedxJerryHack +' + ddi + number))
  ...
  console.log(gradient('black', 'black')('■'))
  console.log(gradient('black', 'black')('■'))
  let ddi = prompt(gradient('purple', 'cyan')('[+] Enter Your Country Code Without + : '));
  let number = prompt(gradient('purple', 'cyan')('[+] Enter Victim Number : '))
